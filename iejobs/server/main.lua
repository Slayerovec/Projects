...
local ESX, load, update, updateTimeLeft, started = nil, nil, false, 0, false
...
local total_count = 0
    ...
    if success == #items then
        ...
        TriggerClientEvent('kkrp_oznameni:client:SendAlert', _source, { type = 'info', text = ('Nemáš dostatek věcí!')})
    end
end)
